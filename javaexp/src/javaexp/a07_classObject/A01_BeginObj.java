...
1. OOP : Object Oriented Programming
         - 부품 객체 먼저 만들고 이것을 하나씩 조립해 완성된 프로그램을 만드는 기법
2. 객체란?
   ...
   3) 객체는 필드(속성)과 메소드(동작)으로 구성된 자바 객체로 모델링 가능한 것.
      ...
      - 자바세계
          사람객체
             ...
             - [메서드] : 웃다, 먹다, 말하다
3. 객체의 상호 작용
   - 객체들은 서로 간의 기능(동작)을 이용해서 데이터를 주고 받고 기능올 처리한다.
     사람 객체 <==> 전자 계산기 객체
     물건 객체 <==> 쇼핑몰 객체
...
1. 현실세계 비유
     현실세계 : 설계도 ==> 구체적인 사물/객체
     	ex) 롯데월드 타워의 설계도를 통해서 롯데월드 타워생성
     자바 : 클래스 ==> 객체
...
3. 클래스부터 만들어진 객체를 해당 클래스의 인스턴스(instance)
   ...
   ex) 하나의 클래스를 기준으로 여러개의 객체가 생성
       Person p01 = new Person();
       Person p02 = new Person();
       Person p03 = new Person();
       p01, p02,p03 등 다른 주소로 객체 생성이 된다.
4. 하나의 클래스로부터 여러 개의 인스턴스를 만들 수 있다.
   하나의 롯데월드타워 도면으로부터 서울, 부산, 제주도에 실제 건물을 건출 할 수 있다.
   아래 Book클래스를 통해 b1,b2,b3의 여러 객체를 생성하여 이름을 할당한다.
    */
		// 클래스를 통해서 만들어진 객체
		// 클래스명 참wh 변수 = new 클래스명();
		...
		// 패키지명.클래스@16진수로heap영역의 주소 값
		System.out.println(busan);
		System.out.println(jeju);
		// Book 클래스를 선언하고, b01,b02,b03객체를 생성하세요. 각, 참조주소를 확인하세요.
		Book b01 = new Book();
		Book b02 = new Book();
		Book b03 = new Book();
...
/*
 주의) class에 클래스를 선언할 수 있는데, Public클래스는 1개 선언
      public 클래스가 파일명.java로 사용되고, main()도 사용 가능하다.
*/
class LotteTower{}
class Book{}