...
4. 변경처리
   1) 기본데이터 ==> Wrapper class(Boxing)
      Integer ob1 = Interger.vlaueOf(1000);
...
//		numWrap01.XXXX()를 통해 포함되는 여러기능메서드 지원
		...
		float n2 = Float.valueOf("40.7F");
		short n3 = Short.valueOf("30");
		char n4 = Character.valueOf('a');
		System.out.println(n1);
		System.out.println(n2);
		System.out.println(n3);
		System.out.println(n4);
		// boxing(객체) 되었을 때 지원하는 여러가지 기능 메서드를 활용할 목적으로 처리
		
		//UnBoxing : 기본 유형의 데이터로 할당

/*
# Auto Boxing/Auto unBoxing
1. 기본데이터 유형을 보다 간편하게 객채형으로 또는 기본 유형으로 변경처리하는 기능이 필요해서
   자바에서는 이러한 auto 기능을 대입연산자로 지원하고 있다.
 */
		// Auto Boxing
		...
		//ex) args에서 3000 true 40.2F 문자열로 입력받아서 각가의 Wrapper 클래스에 할당하고 출력하세요.
