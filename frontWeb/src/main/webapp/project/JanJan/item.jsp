            ...
            <section> <!--여기에 콘텐츠 넣으시면 됩니다.-->               
                <div class = "pro_info_all">
                   ...
                   for(Alcohol al:alist){%>
                    <div> <!--제품 대표 이미지-->
                        <img alt ="제품 대표 이미지" 
                        	src = "<%=al.getAlcoholImg() %>" class = "pro_main">
                    </div>
                    <div class = "pro_info"><!--제품 설명-->
                        <div>
                            <div class="pro_name">
                                <p id="al_name" name="al_name">
                                <%=al.getAlcoholName()%></p> 
                            </div>
                            ...
                            <div class = "price">
                                ...
                                <div>
                                    <span class = "price02">
                                    <%=String.format("%,d",al.getPrice())%>원</span>
                    ...
                    <div class = "box_opt">
                        ...
                        <script type="text/javascript">
	                        ...
	                        function calculateTotalPrice() {
	                        	  var quantity 
	                        	  	= parseInt(document.getElementById('result').innerText); // 수량 가져오기
	                        	  var unitPrice 
	                        	  	= <%=al.getPrice()%>; // 단위 가격 설정
