...
<head>
    ...
    <script type="text/javascript">    	// window.onload와 동일한 메서드
...
<body>
<%
// ex) 구매 물품의 가격을 클라이언트(브라우저)에 쿠키값을 누적시키는 처리
    	...
    	<h2>구매 가격 등록(쿠키 누적)</h2>
	 	...
	 	for(Cookie ck:cks){
	 		if(ck.getName().equals("price")){
	 			ckPrice = Integer.parseInt(ck.getValue());
	 		}
	 	}
