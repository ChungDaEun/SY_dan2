...
4. 요청값 처리 기능
   ...
   요청값과 저장하는 메서드이름이 다를때 요청값 이름으로 property를 연동할 때 param을 활용한다.
   ...
   querystring이 property와 동일한 이름과 할당가능한 type으로 선언되어 있으면 자동으로 모두 다 할당 하겠습니다.
...
<body>
	...
	4. getProperty나 el로 데이터 호출..
	 --%>
	<jsp:useBean id="p01" class="a01_diexp.z04_vo.Person"
		scope="session"/>
